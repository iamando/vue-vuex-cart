  ...
  <div class="container mx-auto">
    <div class="w-1/2 flex justify-center items-center mx-auto">
      <form action="" class="form bg-white p-6 my-10 relative">
        <div
          class="icon bg-indigo-600 text-white w-6 h-6 absolute flex items-center justify-center p-5"
          style="left: -40px"
        >
          <i
        ...
        <input
          type="submit"
          value="Submit"
          class="w-full cursor-pointer mt-6 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold p-3"
        />
      </form>
    </div>
  </div>
...
.icon::after {
  ...
  border-left: 12px solid rgba(79, 70, 229);
  left: 100%;
  top: 0;
}
</style>
